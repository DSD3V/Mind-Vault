...
export const selectIsAddingVault = createSelector(
  [selectVaultState],
  state => state.isAddingVault
);

export const selectIsDeletingVault = createSelector(
  [selectVaultState],
  state => state.isDeletingVault
);
...
export const selectIsEditingVaults = createSelector(
  [selectVaultState],
  state => state.isEditingVaults
);
